...
// this is the autocomplete functionality - i commented it out after i got the submit button working
...
//  });
  ...
  document.getElementById('get-directions-button').addEventListener('click', function() {
    CalcRoute();
    onPlaceChanged('a')
    onPlaceChanged('b')
});
